...
from llm.utils.utils import seed_all
...
def cfg_train_global() -> DictConfig:
    ...
    with initialize(version_base="1.3", config_path="../configs"):
        cfg = compose(config_name="train_testing.yaml", return_hydra_config=True, overrides=[])
...
def cfg_eval_global() -> DictConfig:
    ...
    with initialize(version_base="1.3", config_path="../configs"):
        cfg = compose(
            config_name="eval_testing.yaml", return_hydra_config=True, overrides=["ckpt_path=."]
        )
...
@pytest.fixture(scope="package")
def model() -> Any:
    return GPT2LMHeadModel.from_pretrained("openai-community/gpt2")
